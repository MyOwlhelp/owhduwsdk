...
local function LoadFromUrl(x)
	local BASE_USER = "MyOwlhelp"
	local BASE_BRANCH = "SynX"
	--local BASE_URL = "https://raw.githubusercontent.com/%s/Advanced-Decompiler-V3/%s/%s.lua"
	local BASE_URL = "https://raw.githubusercontent.com/%s/owhduwsdk/%s/%s.lua"
...
local Implementations = LoadFromUrl("Implementationsold")
local Reader = LoadFromUrl("Readerold")
local Strings = LoadFromUrl("Stringsold")
local Luau = LoadFromUrl("Luaudecompold")
